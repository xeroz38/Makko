...
public final class HorizontalPager extends ViewGroup
{
     ...
     */
    private static final int ANIMATION_SCREEN_SET_DURATION_MILLIS = 300;
...
//        }
    ...
    public boolean onInterceptTouchEvent(final MotionEvent ev)
    {
        ...
        int childIndex = getCurrentScreen();
        ImageViewTouch ivt = (ImageViewTouch) getChildAt(childIndex);
        ...
        switch (action)
        {
            case MotionEvent.ACTION_MOVE:
                ...
                if (mTouchState == TOUCH_STATE_HORIZONTAL_SCROLLING)
                {
                     ...
                     */
                    if ((ivt.isHitLeft() || ivt.isHitRight()) && !ivt.isZooming)
                    {
                        intercept = true;
                    }
//                    intercept = false;
    ...
    public void computeScroll()
    {
        ...
        else if (mNextScreen != INVALID_SCREEN)
        {
            ...
            {
                Log.i("HorizonalPager", "mOnScreenSwitchListener called");
     ...
     */
    public void snapToScreen(final int whichScreen, final int duration)
    {
        /*
